...
async function testCorrectSpelling() {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${SHIPBUBBLE_BASE_URL}/shipping/fetch_rates`, requestBody, { headers, timeout: 30000 });
        console.log('✅ ✅ ✅ SUCCESS! ✅ ✅ ✅\n');
        ...
        if (response.data.data?.couriers) {
            response.data.data.couriers.slice(0, 10).forEach((courier, i) => {
...
//# sourceMappingURL=test-shipbubble-correct-spelling.js.map