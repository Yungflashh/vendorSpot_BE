...
async function debugRequest() {
    ...
    try {
        ...
        try {
            const response1 = await axios_1.default.post(`${SHIPBUBBLE_BASE_URL}/shipping/fetch_rates`, requestBody1, { headers });
        ...
        try {
            const response2 = await axios_1.default.post(`${SHIPBUBBLE_BASE_URL}/shipping/fetch_rates`, requestBody2, { headers });
        ...
        try {
            const response3 = await axios_1.default.post(`${SHIPBUBBLE_BASE_URL}/shipping/fetch_rates`, requestBody3, { headers });
...
//# sourceMappingURL=debug-shipbubble-request.js.map