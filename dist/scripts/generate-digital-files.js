...
const OUTPUT_DIR = path_1.default.join(__dirname, '../public/downloads');
...
// ============================================================
async function createZip(fileName, contents) {
    return new Promise((resolve, reject) => {
        const output = fs_1.default.createWriteStream(path_1.default.join(OUTPUT_DIR, fileName));
...
async function generateAllFiles() {
    try {
        ...
        await createPDF('financial-literacy-guide.pdf', 'Financial Literacy Guide', [
        ...
        await createPDF('productivity-planner-digital.pdf', 'Productivity Planner 2026', [
...
generateAllFiles();
//# sourceMappingURL=generate-digital-files.js.map